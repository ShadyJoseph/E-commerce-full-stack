...
const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({ isLoading, onClick, mssg }) => (
  <div className="flex items-center justify-center">
    <button
      onClick={onClick}
      disabled={isLoading}
      className={`flex items-center justify-center w-full h-12 px-6 text-gray-700 dark:text-gray-200 font-semibold rounded-full border transition-all ${
        isLoading ? 'bg-gray-200 dark:bg-gray-700 cursor-not-allowed' : 'bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 shadow-sm hover:shadow-lg'
      }`}
    >
      {isLoading ? (
        ...
        <div className="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" height="24px" width="24px" className="mr-2">
